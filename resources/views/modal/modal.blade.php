<div class="modal fade" id="modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div id="modalSize" class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content" style="background-color: #DFE6EC; border-radius: 1rem;">
            <div class="my-0 py-0 modal-header" style="background: #92499C; padding: 0.5rem !important;">
                <h2 style="color:white; padding-left: 1rem !important; color: #DFE6EC; font-size: 1.5rem;"
                    class="modal-title w-100 d-flex justify-content-center justify-content-lg-start" id="modalTitle">
                    Ticket Turno | Proyecto
                </h2>
                <button type="action"
